...
public class ContactServiceImpl implements IContactService {
    ...
    public List<ContactResponseDto> fetchNewContactMsgs() {
        List<Contact> contacts = contactRepository.findContactByStatus(ApplicationConstants.NEW_MESSAGE);
    ...
    public List<ContactResponseDto> fetchNewContactMsgsWithSort(String sortBy, String sortDir) {
        ...
        List<Contact> contacts = contactRepository.findContactByStatus(
    ...
    public boolean closeContactMsg(Long id, String status) {
        int updatedRaws = contactRepository.updateStatusById(status, id, ApplicationUtility.getLoggedInUser());
